...
from playwright.sync_api import Page, Browser, Playwright, Locator, TimeoutError
...
class Driver:
    ...
    def get_month_name(self, page: Page) -> str:
        month_button = page.locator(self.month_button_locator).last
    ...
    def setup_main_page(self, page: Page) -> None:
        ...
        # Choose one way ticket (only click the first matching element to avoid strict-mode violation)
